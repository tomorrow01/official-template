  ...
  <div class="news-module">
    ...
    <nuxt-link v-if="newsList.length" class="common-move-btn" to="/news/">
      <div :class="[isMobile ? 'common-row common-center' : '']" class="common-move-btn-content btn-content bg-normal2">
        ...
        <div class="btn-arrow">
          <img src="/images/index/black_arrow_hover@1x.png" alt="" class="arrow-img hidden-xs-only" />
          <img src="/images/index/arrow_mobile2.png" alt="" class="arrow-img hidden-sm-and-up" />
        </div>
      </div>
    </nuxt-link>
