      ...
      <div class="container">
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <a 
            ...
            :key="service.id" 
            href="/services" 
            class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8 flex flex-col bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1"
          >
            <!-- 卡片内部：图片在上 -->
