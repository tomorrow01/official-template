      ...
      <div class="container">
        ...
        <div style="display: flex; flex-wrap: wrap; margin: 0 -12px;">
          ...
          <a 
            ...
            :key="service.id" 
            href="/services" 
            style="width: 33.3333%; padding: 0 12px; margin-bottom: 24px; box-sizing: border-box;"
...
<style scoped>
.service-card-wrapper { display: flex; flex-wrap: wrap; margin: 0 -12px; }
.service-card-item { width: 33.3333% !important; padding: 0 12px; margin-bottom: 24px; box-sizing: border-box; }
@media (max-width: 768px) { .service-card-item { width: 50% !important; } }
@media (max-width: 640px) { .service-card-item { width: 100% !important; } }
</style>
