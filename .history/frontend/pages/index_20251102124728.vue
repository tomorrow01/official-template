<template>
  <div class="home-container" style="margin-top: 0; padding-top: 0; position: relative;">
    ...
    <!-- 核心服务模块 -->
    <section class="services-section py-6 bg-gray-50" style="margin-top: 0; margin-bottom: 0;">
      <div class="container">
        <!-- 区块标题 -->
      ...
      <div class="container">
        ...
        <div class="clients-logos mt-10 py-6 border-t border-gray-200">
          ...
          <div class="flex flex-wrap justify-center gap-6">
            <div v-for="i in 6" :key="i" style="flex: 0 0 auto; width: calc(33.333% - 16px); min-width: 150px; max-width: 200px;">
              <div class="client-logo flex justify-center opacity-60 hover:opacity-100 transition-opacity">
                <img 
                  ...
                  alt="合作伙伴" 
                  class="max-h-12 grayscale hover:grayscale-0 transition-all w-auto"
                >
              </div>
            </div>
          </div>
    ...
    <!-- 数据统计 -->
    <section class="stats-section py-6 bg-gradient-to-r from-primary to-secondary text-white">
      <div class="container">
