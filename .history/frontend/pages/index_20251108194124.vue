  ...
  <div class="home-container" style="margin-top: 0; padding-top: 0; position: relative;">
    ...
    <section class="services-section py-12 bg-gray-50" style="margin-top: 0; margin-bottom: 0;">
      <div class="container">
        ...
        <div class="service-grid" style="display: flex !important; flex-wrap: wrap !important; margin: 0 -12px; width: calc(100% + 24px);">
          <!-- 每个服务项是一个独立卡片 -->
          <a 
            ...
            href="/services" 
            class="service-card" 
            style="flex-shrink: 0; width: 100%; padding: 0 12px; margin-bottom: 24px; box-sizing: border-box;
                  @media (min-width: 768px) { width: 50%; }
                  @media (min-width: 1024px) { width: 33.3333%; }
                  display: block;"
          >
            <div class="flex flex-col bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1 h-full">
              <!-- 卡片内部：图片在上 -->
