      ...
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            ...
            :key="caseItem.id" 
            class="case-card bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl group flex flex-col"
            :style="{animationDelay: `${index * 100}ms`}"
          >
            <!-- 图片部分 - 占满整行 -->
            <div class="case-image-container w-full h-48 md:h-56 overflow-hidden">
              <img 
            ...
            <div class="p-6">
              ...
              <p class="case-desc text-gray-600 mb-4">
