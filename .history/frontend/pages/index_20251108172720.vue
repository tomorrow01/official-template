  ...
  <div class="home-container" style="margin-top: 0; padding-top: 0; position: relative;">
    ...
    <section class="services-section py-12 bg-gray-50" style="margin-top: 0; margin-bottom: 0;">
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8 w-full">
          <!-- 每个服务项是一个独立卡片 -->
          <a 
            v-for="(service, index) in services" 
            :key="service.id" 
            href="/services" 
            class="flex flex-col bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1 min-w-0 max-w-full"
          >
            <!-- 卡片内部：图片在上 -->
