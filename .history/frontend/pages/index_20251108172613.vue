      ...
      <div class="container">
        ...
        <div class="flex flex-wrap justify-start">
          ...
          <a 
            ...
            :key="service.id" 
            href="/services" 
            class="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 p-4 flex flex-col bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1" style="flex-shrink: 0;"
          >
            <!-- 卡片内部：图片在上 -->
