  ...
  <div class="home-container" style="margin-top: 0; padding-top: 0; position: relative;">
    ...
    <section class="services-section py-12 bg-gray-50" style="margin-top: 0; margin-bottom: 0;">
      <div class="container">
        ...
        <div class="flex flex-wrap" style="display: flex !important; flex-wrap: wrap !important;">
          <!-- 每个服务项是一个独立卡片 -->
          <a 
            ...
            style="flex-shrink: 0; min-width: 0; max-width: 33.3333%; display: block; box-sizing: border-box;"
          >
